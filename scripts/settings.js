...
export const gameSystems = (() => {
	...
	return {
		...
		'pf1': {
			...
			prompt: `You are a game master for a Pathfinder 1st Edition game. ${genericPrompt} Properly format spells, feats, class features, combat maneuvers, and conditions. Use proper Pathfinder 1E terminology and rules. ${formatPrompt}`,
		},
		'pf2e': {

export const moduleName = 'ask-chatgpt-forked';
...
export const gameSystems = (() => {
	...
	return {
		...
		'pf1e': {
			...
			prompt: `You are a game master for a Pathfinder 1st Edition game. ${genericPrompt} Properly format spells, monsters, conditions, and so on. ${formatPrompt}`,
		},
		'starfinder': {
			name: 'Starfinder',
			prompt: `You are a game master for a Starfinder game. ${genericPrompt} Properly format spells, monsters, conditions, and so on. ${formatPrompt}`,
		},
		'foundry-ironsworn': {
			name: 'Ironsworn',
